...
if ((typeof define !== "undefined" && define !== null ? define.amd : void 0) != null) {
  define('joosy/modules/widgets_manager', function() {
    return Joosy.Modules.WidgetsManager;
  });
}
;
var _this = this,
...
Joosy.Router = (function(_super) {
  ...
  Router.prototype.respond = function(path) {
    ...
    for (regex in _ref1) {
      ...
      if (this.routes.hasOwnProperty(regex)) {
        if (match = path.match(new RegExp(regex))) {
          this.__respond(route.to, this.__grabParams(route, query, match));
    ...
    if (this.wildcardAction != null) {
      this.__respond(this.wildcardAction, this.__grabParams(this.wildcardAction, query));
  ...
  Router.prototype.__grabParams = function(route, query, match) {
    var params, _ref;
    if (query == null) {
      query = [];
    }
