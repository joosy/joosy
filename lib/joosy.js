...
Joosy.helpers('Application', function() {
  return this.widget = function(tag, options, widget) {
    ...
    this.__owner.setTimeout(0, function() {
      return _this.__owner.registerWidget($('#' + options.id), widget);
    });
...
Joosy.Modules.Renderer = {
  ...
  __instantiateHelpers: function() {
    ...
    if (!this.__helpersInstance) {
      ...
      this.__helpersInstance.__owner = this;
      if (this.__helpers) {
        _ref = this.__helpers;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          helper = _ref[_i];
  ...
  __instantiateRenderers: function(stack) {
    var _this = this;
    return {
  ...
  __render: function(dynamic, template, locals, parentStackPointer) {
    var assignContext, binding, context, key, morph, object, result, stack, update,
      _this = this;
    if (locals == null) {
      locals = {};
    }
...
Joosy.Layout = (function(_super) {
  ...
  Layout.prototype["yield"] = function() {
    return this.uuid || (this.uuid = Joosy.uuid());
  };
